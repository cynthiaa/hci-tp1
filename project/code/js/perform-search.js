...
function displayFlights(flights, path){
	...
	if(flights.hasOwnProperty("error")){
		...
		for(var i=0;i<flights.total;i++){
			...
			var price_div = $("<div id='price'><p><b><span id='price_tag' class='translate'>Precio:</span><br>"+total+"</b><br><a class='view_price_detail'>(Ver detalles)</a><br></p><p><a class='button' href='summary.html"+buy_query+"'><span id='buy_label' class='translate'>Comprar</span></a></p></div>").appendTo(new_div);
